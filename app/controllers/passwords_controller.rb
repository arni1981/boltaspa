class PasswordsController < ApplicationController
  ...
  def update
    if @user.update(params.permit(:password, :password_confirmation))
      ...
      redirect_to new_session_path, notice: t('controllers.passwords.password_reset_success')
    else
      redirect_to edit_password_path(params[:token]), alert: t('controllers.passwords.passwords_dont_match')
    end
  end
